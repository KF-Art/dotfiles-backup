...
active_bg=
active_underline="#00875F"

inactive_text_color="#949494"
inactive_bg=
inactive_underline=

separator="   |   "
show="window_title" # options: window_title, window_class, window_classname
forbidden_classes="Polybar Conky Gmrun Xfce4-panel"
empty_desktop_message="Void Fluxbox"
...
inactive_right="%{F-}"
separator="%{F$active_bg}$separator%{F-}"
